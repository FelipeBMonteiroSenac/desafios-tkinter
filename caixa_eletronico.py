#Author: dinizdemagalhaes-design
...
label_titulo = tk.Label(
    root, text="Caixa Eletrônico", font=("Arial", 16, "bold"), bg="#f0f0f0"
)
label_titulo.place(relx=0.5, rely=0.1, anchor="center")

# texto do valor
label_valor = tk.Label(
    root, text="Digite o valor do saque:", font=("Arial", 11), bg="#f0f0f0"
)
...
label_resultado = tk.Label(
    root, text="", font=("Arial", 11), bg="#f0f0f0", justify="left"
)
